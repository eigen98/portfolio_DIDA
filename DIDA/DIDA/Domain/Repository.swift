...
final class Repository: TestCommunityRepositoryType {
    ...
    func fetchTestNoisyData() -> [SectionItem] {
        return [SectionItem.noisyItem(TestNoisyData(test: [Colors.text_notice!,Colors.brand_ivory!,Colors.brand_ivory!,Colors.brand_lemon_1000!,Colors.brand_ivory!,Colors.brand_lemon_1000!,Colors.text_notice!,Colors.brand_ivory!,Colors.brand_lemon_1000!]))]
    }
    func fetchTestPostData() -> [SectionItem] {
